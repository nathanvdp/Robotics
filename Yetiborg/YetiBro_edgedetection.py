...
try:
    while(True):
        ...
        draw_line = np.zeros((60,160), dtype=np.utin8)
        if lines is not None:
            for line in lines:
                ...
                y2 = int(y0 - 1000*(a))
                #x1, y1, x2, y2 = line[0]
                cv2.line(draw_line, (x1,y1),(x2,y2), 255,20)
        ...
        contours,hierarchy = cv2.findContours(draw_line.copy(), 1, cv2.CHAIN_APPROX_NONE)
